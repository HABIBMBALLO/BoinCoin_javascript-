...
#LOMBA-TECH 
"# BON_COIN_JS" >>
# E-mail : mballohabib93@gmail.com
==================================================================================================
# clean-code_js
...
12. [Translation](#Translationtion)
...
describe("MomentJS", () => {
  it("handles 30-day months", () => {
    const date = new MomentJS("13/05/2020");
    date.addDays(30);
    assert.equal("13/05/2015", date);
  });

  it("handles leap year", () => {
    const date = new MomentJS("13/05/2020");
    date.addDays(28);
    assert.equal("02/29/2020", date);
  });
